...
from base import (
    TestSearchEngineBase,
    assert_ascending, assert_descending,
    assert_ascending_by, assert_descending_by,
)
from uszipcode.search import (
    Zipcode, ZipcodeType, SORT_BY_DIST, DEFAULT_LIMIT,
)


class TestSearchEngineUtility(TestSearchEngineBase):
...
class TestSearchEngineByZipcodeAndCoordinates(TestSearchEngineBase):
